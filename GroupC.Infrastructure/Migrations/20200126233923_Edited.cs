        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestCenters_AspNetUsers_Id",
                        column: x => x.Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseId = table.Column<Guid>(nullable: false),
                    TestCenterId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Exams_TestCenters_TestCenterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubmissionChoices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubmissionChoices_Choices_ChoiceId",
                        column: x => x.ChoiceId,
                        principalTable: "Choices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SubmissionChoices_Submissions_SubmissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubmissionChoices_ChoiceId",
                table: "SubmissionChoices",
                column: "ChoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_SubmissionChoices_SubmissionId",
                table: "SubmissionChoices",
                column: "SubmissionId");
